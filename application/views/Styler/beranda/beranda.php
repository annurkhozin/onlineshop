  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div id="sliderpro3" class="slider-pro main-slider">
        <div class="sp-slides">
          <div class="sp-slide">
            <img class="sp-image" src="<?=base_url()?>assets/media/main-slider/d.png" data-src="<?=base_url()?>assets/media/main-slider/d.png" data-retina="<?=base_url()?>assets/media/main-slider/d.png" alt="img"/>
          ...
          <div class="sp-slide">
            <img class="sp-image" src="<?=base_url()?>assets/media/main-slider/z.png" data-src="<?=base_url()?>assets/media/main-slider/z.png" data-retina="<?=base_url()?>assets/media/main-slider/z.png" alt="img"/>
    ...
    <div class="col-xs-12">
      <div class="section-area section-default">
        <div class="subscribe subscribe_mod-a"><i class="subscribe__icon fa fa-shopping-cart"></i>
          ...
          <form class="subscribe__form form-inline" method="post" action="<?=base_url()?>transactionCheck">

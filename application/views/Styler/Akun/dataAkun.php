        ...
        <section class="section-area section-contacts">
          <h2 class="ui-title-block ui-title-block_small"><i class="icon fa fa-map-marker"></i>Alamat Anda</h2>
            <div class="row form-contact ui-form">
              <div class="col-md-12">
                <div class="col-md-12">
                  <input class="form-control" name="address_name" type="text" placeholder="Nama Alamat" required>
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-6">
                  <select class="form-control" required name="propinsi_asal" id="propinsi_asal">
                      <option value="" selected="" disabled="">Pilih Provinsi</option>
                      <?php $this->load->view('Styler/rajaongkir/getProvince'); ?>
                    </select>
                </div>
                <div class="col-md-6">

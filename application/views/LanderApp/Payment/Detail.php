			...
			<div class="panel-body">
				<form class="form-horizontal">
					...
					<div class="row form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" value="<?=$row['payment_name']?>" disabled>
						</div>
					</div>
					<div class="row form-group">
						<label class="col-sm-3 control-label">Pemilik Akun :</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" value="<?=$row['payment_account_name']?>" disabled>
						</div>
					</div>
					<div class="row form-group">
						<label class="col-sm-3 control-label">Nomor Akun :</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" value="<?=$row['payment_number']?>" disabled>
						</div>
					</div>
					<div class="row form-group">
